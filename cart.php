    ...
    <div class="container">
        <div class="row">
            <div class="col d-flex justify-content-end mb-2">
                <button class="btn btn-outline-dark btn-flat btn-sm" type="button" id="empty_cart">Làm Trống Giỏ Hàng</button>
            </div>
        </div>
...
<script>
    ...
    $(function(){
        ...
        $('#empty_cart').click(function(){
            // empty_cart()
            _conf("Bạn có chắc muốn làm trống giỏ hàng không?",'empty_cart',[])
        })
        $('.rem_item').click(function(){
            _conf("Bạn có chắc muốn xóa sản phẩm này khỏi giỏ hàng không?",'rem_item',[$(this).attr('data-id')])
        })
    })
</script>