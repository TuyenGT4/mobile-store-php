...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Bạn có chắc chắn muốn xóa vĩnh viễn Thương Hiệu này không?","delete_brand",[$(this).attr('data-id')])
		})
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Thêm Thương Hiệu Mới","maintenance/manage_brand.php")
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Cập Nhật Thông Tin Thương Hiệu","maintenance/manage_brand.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
